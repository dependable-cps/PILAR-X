...
namespace OpenCVForUnityExample
{
    ...
    public class ObjectDetectionYOLOXExample : MonoBehaviour
    {
        ...
        private Mat results;
        public static Action<string> OnResultGenerated;
            ...
            else
            {
                ...
                var getFilePathAsync_0_Coroutine = Utils.getFilePathAsync("OpenCVForUnity/dnn/" + testInputImage, (result) =>
                {
                    ...
                    else
                    {
                        ...
                        //objectDetector.GetDetectedData(results);
                    }
        ...
        void Update()
        {
            ...
            if (webCamTextureToMatHelper.IsPlaying() && webCamTextureToMatHelper.DidUpdateThisFrame())
            {
                ...
                else
                {
                    ...
                    results = objectDetector.infer(bgrMat);
        ...
        public void OnPauseButtonClick()
        {
            ...
            OnResultGenerated?.Invoke(objectDetector.GetDetectedData(results));
        }
